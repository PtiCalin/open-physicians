...
def fetch_latest(*, output_dir: Path | None = None) -> Path:
    """Download the latest College of Physicians and Surgeons of Ontario dataset and return the written path."""
    target_dir = output_dir or RAW_DIR
    target_dir.mkdir(parents=True, exist_ok=True)
    raise NotImplementedError("Implement fetch_latest for cpso")
